...
public class IntegerEquality {
    ...
    /**
     *  If the first integer is equal to second integer
    ...
    /**
     *  If the first integer is not equal to second integer
     *  then the method returns true
     *  else the method returns false
     *
     * @param first java.lang.Integer
    ...
    /**
     * If the first integer is less than second integer
     * then the method returns true
     * else the method returns false
     * @param first
     * @param second
    ...
    /**
     * If the first integer is more than second
     * then the method returns true
     * else the method returns false
     *
     * @param first java.lang.Integer
    ...
    /**
     *
     * If the first integer is less than or equal to second integer
     * then the method returns true
     * else the method returns false
     *
     * @param first java.lang.Integer
    ...
    /**
     * If the first integer is more than or equal to second integer
     * then the method returns true
     * else returns false
     *
     * @param first java.lang.Integer
