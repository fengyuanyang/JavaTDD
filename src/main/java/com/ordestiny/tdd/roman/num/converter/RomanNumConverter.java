...
public class RomanNumConverter {
    private HashMap<Integer,String> ones = new HashMap<Integer, String>();
    private HashMap<Integer,String> tens = new HashMap<Integer, String>();
    private HashMap<Integer,String> hundreds = new HashMap<Integer, String>();
    private HashMap<Integer,String> thousands = new HashMap<Integer, String>();

    private String res_ones = "";
    private String res_tens = "";
    private String res_hundreds = "";
    private String res_thousands = "";
     ...
     */
      public String convert_roman_numeral(int n){
        ...
        if (n >= 4000 || n==0) throw new IllegalArgumentException();
